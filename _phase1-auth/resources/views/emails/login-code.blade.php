    ...
    <tr><td align="center">
      <table role="presentation" width="440" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden;">
        ...
        <tr><td style="padding:0 32px;">
          <div style="font-size:34px;font-weight:700;letter-spacing:10px;color:#1b5f8a;background:#eef1f4;border-radius:10px;text-align:center;padding:18px 0;">{{ $code }}</div>
        </td></tr>
        <tr><td style="padding:20px 32px 28px;">
          <p style="font-size:13px;color:#9ca3af;margin:0;">This code expires in {{ $ttlMinutes }} minutes and can be used once. If you didn't request it, you can safely ignore this email.</p>
        </td></tr>
      </table>
