...
| require __DIR__.'/projects.php'; from routes/web.php
*/
...
Route::middleware(['auth', 'workspace.tenancy'])
    ...
    ->group(function () {
        ...
        // Open + lifecycle (PRJ-028/045/046/047)
