<?php $__env->startSection('title', 'Onboarding · Role — Project Block'); ?>
...
<?php $__env->startSection('body'); ?>
  ...
  <header class="flex items-center justify-between px-5 sm:px-10 py-5">
    <div class="flex items-center gap-3">
      <a href="<?php echo e(route('onboarding.profile')); ?>" class="h-8 w-8 grid place-items-center rounded-md text-sub hover:bg-hover">
  ...
  <main class="flex-1 flex justify-center px-5">
    <div class="w-full max-w-[430px] py-6 sm:py-12">
      ...
      <form method="POST" action="<?php echo e(route('onboarding.role.store')); ?>" id="role-form">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="role" id="role-input" value="<?php echo e(old('role', $user->onboardingProfile->role_selection ?? '')); ?>" />
        <div id="role-list" class="space-y-2.5">
          <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button" data-role="<?php echo e($key); ?>"
              ...
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" class="shrink-0"><path d="<?php echo e($roleIcons[$key] ?? $roleIcons['oth']); ?>" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>
      ...
      <form method="POST" action="<?php echo e(route('onboarding.role.skip')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/rohitphilip/Sites/pblock3.0/resources/views/onboarding/role.blade.php ENDPATH**/ ?>