<?php $__env->startSection('title', 'Onboarding · Goals — Project Block'); ?>
...
<?php $__env->startSection('body'); ?>
  ...
  <header class="flex items-center justify-between px-5 sm:px-10 py-5">
    <div class="flex items-center gap-3">
      <a href="<?php echo e(route('onboarding.role')); ?>" class="h-8 w-8 grid place-items-center rounded-md text-sub hover:bg-hover">
  ...
  <main class="flex-1 flex justify-center px-5">
    <div class="w-full max-w-[430px] py-6 sm:py-12">
      ...
      <?php $current = old('goals', $user->onboardingProfile->goals ?? []); ?>

      <form method="POST" action="<?php echo e(route('onboarding.goals.store')); ?>" id="goals-form">
        <?php echo csrf_field(); ?>
        <div id="goal-list" class="space-y-2.5">
          <?php $__currentLoopData = $goals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <button type="button" data-goal="<?php echo e($key); ?>"
              ...
              <input type="checkbox" name="goals[]" value="<?php echo e($key); ?>" class="hidden" <?php if(in_array($key, (array) $current, true)): echo 'checked'; endif; ?>>
            </button>
      ...
      <form method="POST" action="<?php echo e(route('onboarding.goals.skip')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/rohitphilip/Sites/pblock3.0/resources/views/onboarding/goals.blade.php ENDPATH**/ ?>