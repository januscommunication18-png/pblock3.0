<?php $__env->startSection('title', 'Get started — Project Block'); ?>
...
<?php $__env->startSection('body'); ?>
  ...
  <header class="h-14 shrink-0 border-b border-line flex items-center gap-2 px-3 sm:px-4">
    ...
    <div class="flex items-center gap-1.5 shrink-0">
      <a href="<?php echo e(route('projects.index')); ?>" class="inline-flex items-center h-8 px-3 rounded-md text-[13px] text-ink hover:bg-hover">Projects</a>
      ...
      <div class="relative ml-1">
        ...
        <div id="user-menu" class="hidden absolute right-0 top-full mt-2 w-64 bg-white border border-line rounded-xl shadow-lg z-50 p-1.5">
          ...
          <div class="pt-1.5">
            <a href="<?php echo e(route('projects.index')); ?>?create=1" class="w-full text-left flex items-center gap-2.5 px-2.5 h-9 rounded-lg text-[13px] text-ink hover:bg-hover">
  ...
  <div class="flex-1 flex min-h-0 relative">
    ...
    <main class="flex-1 min-w-0 overflow-y-auto">
      ...
      <div class="max-w-[820px] mx-auto px-5 sm:px-8 py-8">
        <h1 class="text-[24px] sm:text-[26px] font-bold text-head">Hey <?php echo e($user->displayName()); ?>, welcome aboard! 👋</h1>
        ...
        <div class="border border-line rounded-xl p-5 flex items-center gap-4">
          ...
          <a href="<?php echo e(route('workspaces.invite')); ?>" class="ml-auto h-9 px-4 grid place-items-center rounded-md border border-stroke hover:bg-hover text-ink text-[13px] font-semibold shrink-0">Invite</a>
        </div>
        <div class="h-8"></div>
      </div>
    </main>
        ...
        <div class="p-4">
          <div class="flex items-start">
            ...
            <div class="ml-3 w-0 flex-1 pt-0.5">
              ...
              <p class="mt-1 text-[13px] text-sub"><?php echo e(session('status')); ?></p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/rohitphilip/Sites/pblock3.0/resources/views/app/welcome.blade.php ENDPATH**/ ?>