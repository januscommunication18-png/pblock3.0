      ...
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;border:1px solid #e5e7eb;overflow:hidden;">
        ...
        <tr><td style="padding:16px 32px 0;">
          ...
          <p style="font-size:14px;color:#6b7280;margin:0 0 20px;">
            <strong style="color:#23272f;">{{ $actorName }}</strong> marked this work item as blocked in
        ...
        <tr><td style="padding:0 32px;">
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fef2f2;border:1px solid #fecaca;border-radius:10px;">
            <tr><td style="padding:12px 16px 6px;font-size:13px;font-weight:600;color:#b91c1c;">Blocked by</td></tr>
            @foreach ($blockers as $blocker)
              <tr><td style="padding:0 16px 10px;font-size:13px;color:#23272f;">
                <strong>{{ $blocker['identifier'] }}</strong> &nbsp;{{ $blocker['title'] }}
              </td></tr>
            @endforeach
          </table>
        </td></tr>
