...
import { E as EDIT_INPUT_WR, j as getItemByPosition, b as getSourceItem, A as DRAGG_TEXT } from './dimension.helpers-fl4HSSK9.js';
import { T as TextEditor } from './text-editor-DlMnLkRK.js';
import { n as isEditorCtrConstructible } from './edit.utils-4e9fsqOR.js';
import { d as debounce } from './debounce-PCRWZliA.js';
import './index-D24ku9ej.js';
...
const revogrEditStyleCss = () => `revogr-edit{display:block;position:absolute;background-color:var(--rg-theme-background)}revogr-edit input{height:100%;width:100%;box-sizing:border-box;background-color:var(--rg-theme-background)}revogr-edit revo-dropdown{height:100%}revogr-edit revo-dropdown.shrink fieldset legend>span{display:none}`;
