...
import { c as columnTypes, J as reduce, C as getColumnType, r as rowTypes, i as isRowType, D as getColumnSizes, a as cropCellToMax, n as nextCell, I as getColumnByProp, F as getColumns } from './column.service-Cfw3L0PN.js';
...
import { D as DimensionStore, t as themeTokenCssVariables, S as SelectionStore, B as BasePlugin, G as GroupingRowPlugin, a as StretchColumn, i as isStretchPlugin, A as AutoSizeColumnPlugin, f as FilterPlugin, E as ExportFilePlugin, u as SortingPlugin, q as ColumnMovePlugin } from './column.drag.plugin-DKgC_0I1.js';
...
import './header-cell-renderer-Cqtg1ETB.js';
...
const builtInThemeNames = new Set(allowedThemes);
...
function getThemeTokens(tokens) {
    ...
    for (const [name, value] of Object.entries(tokens)) {
        if (Object.hasOwn(themeTokenCssVariables, name) &&
            typeof value === 'string' &&
            value.trim()) {
            result[name] = value;
        }
...
class ThemeService {
    ...
    resolveDefinition(name) {
        ...
        let resolved = Object.assign(Object.assign({}, (validChain && isBuiltInTheme(parentName)
